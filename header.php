						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									...
									<li><a href="boletin_op1.php" style="background-color: rgba(0,0,0,0); color: #fff;">Boletín OP1</a></li>
									<li><a href="boletin_op2.php" style="background-color: rgba(0,0,0,0); color: #fff;">Boletín OP2</a></li>
