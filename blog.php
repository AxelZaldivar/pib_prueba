						...
						<div class="home_content text-center">
							...
							<div class="breadcrumbs">
								<ul>
									...
									<li><a href="./news.php" style="text-shadow: 5px 5px 10px rgba(0,0,0,0.5);">Predicaciones</a></li>
									<li style="text-shadow: 5px 5px 10px rgba(0,0,0,0.5);"><?php echo $nom_sermon;?></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="sidebar_latest_posts">
							...
							<div class="latest_posts">
								<?php
									...
									{
										$consulta = "SELECT * FROM sermones WHERE categoria = $categoria LIMIT 2;";
										$result = mysqli_query($connection,$consulta);
										$error_message = mysqli_error($connection);
										if(!$result) 
										{
